            ...
            <button
              ...
              <div className='px-4 py-2'>
                <div className='flex justify-between'>
                  ...
                  <div
                    className={` ${activeBtn === 'fee' ? 'text-purple font-bold' : 'text-black'} `}>
                    {(order.deliveryFee * 2 + order.deliveryTip).toLocaleString()}원
                  </div>
                </div>
                <div className='text-caption'>
                  <div className='flex justify-between mb-2'>
                    ...
                    <span
                      className={` ${
                        activeBtn === 'dist' ? 'text-purple font-bold' : 'text-black'
                      } ml-8`}>
                      {order.distance} km
                    </span>
                  </div>
