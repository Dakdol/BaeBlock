...
const MenuList = (props) => {
  return (
    <div className='bg-white w-[350px] h-[100px] flex justify-between items-center p-4 rounded-2xl border-2 border-darkGray'>
      <div>
      ...
      <div className='relative bg-darkGray rounded-lg w-20 h-20'>
