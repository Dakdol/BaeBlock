...
function App() {
  ...
  var order_c_address = '0x04BD4987Bf2024A5FCd4FEE111d3735E797dd5Fc';
  var rider_c_address = '0x2F212Ed4836e2585fE035810f0302Bc06554A4A3';
  var store_c_address = '0xd6f87D1B521a9F124a56c59Ac885C4b38804dFb9';
  ...
  const getExchangeRate = async () => {
    try {
      const response = await axios.get(`https://api.upbit.com/v1/ticker?markets= KRW-MATIC`);
