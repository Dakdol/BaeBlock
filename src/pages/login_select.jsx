    ...
    <div>
      ...
      <div className='flex flex-col gap-7 justify-center items-center mt-36'>
        <Link to='/customer/signin'>
          <button className='bg-lightYellow btn-style text-black yellow-shadow'>고객</button>
        </Link>
        <Link to='/store/signin'>
          <button className='bg-lightYellow btn-style text-black yellow-shadow'>매장</button>
        </Link>
        <Link to='/rider/signin'>
          <button className='bg-lightYellow btn-style text-black yellow-shadow'>라이더</button>
        </Link>
      </div>
    </div>
  );
